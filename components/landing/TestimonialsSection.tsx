            ...
            {testimonials.map((testimonial, index) => (
              <StaggerItem key={index}>
                <ScaleOnHover className="h-full">
                  <Card className="h-full bg-slate-900/50 backdrop-blur-sm border-slate-800 rounded-2xl hover:border-slate-600 transition-all duration-300">
                    <CardContent className="pt-6">
                      <Quote className={`w-8 h-8 bg-gradient-to-br ${gradient} bg-clip-text text-transparent mb-4 opacity-70`} style={{ WebkitTextStroke: '0' }} />
        ...
        <div className="container mx-auto max-w-6xl px-4">
          ...
          <StaggerContainer className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <StaggerItem key={index}>
                <ScaleOnHover className="h-full">
                  <Card className="h-full border rounded-2xl hover:shadow-lg transition-all duration-300">
                    <CardContent className="pt-6">
      ...
      <div className="container mx-auto max-w-6xl px-4">
        ...
        <StaggerContainer className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <StaggerItem key={index}>
              <ScaleOnHover className="h-full">
                <Card className="h-full border-slate-200 dark:border-slate-800 rounded-2xl hover:shadow-lg transition-all duration-300">
                  <CardContent className="pt-6">
