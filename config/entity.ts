...
export const entityConfig: EntityConfig = {
  ...
  fields: [
    ...
    },
    {
      ...
      type: 'multi-select',
      required: false,
      options: ['keto', 'vegan', 'gluten_free', 'dairy_free', 'nut_allergy', 'vegetarian'],
      showInList: true,
      showInForm: true,
    },
    {
    ...
    },
    {
      ...
      type: 'select',
      required: false,
      options: ['preference', 'intolerance', 'life_threatening'],
  ...
  descriptionField: 'generated_recipes',
  defaultSort: { field: 'creation_date', direction: 'desc' },
