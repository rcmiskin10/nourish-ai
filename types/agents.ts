...
// Group of multiple choice options (one per question)
...
export interface SocialProof {
  avatars?: string[]  // URLs for avatar images (e.g. DiceBear, Gravatar)
  count?: string      // e.g. "2,000+"
  label?: string      // e.g. "teams worldwide"
}
